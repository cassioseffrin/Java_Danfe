...
public class TesteImpressaoNFCe {
    ...
    public static void main(String[] args) {
        try {
            ...
            String xml = ImpressaoUtil.leArquivo("/Users/cassioseffrin/dev/api-repag/src/certificates/CERTIFICADOS/rip-nfce.xml");
    ...
    private static void impressaoPdfArquivo(Impressao impressao) throws IOException, JRException, ParserConfigurationException, SAXException {
        ImpressaoService.impressaoPdfArquivo(impressao, "/Users/cassioseffrin/dev/api-repag/src/certificates/CERTIFICADOS/teste-nfce.pdf");
    }
